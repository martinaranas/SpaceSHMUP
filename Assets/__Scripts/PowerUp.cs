...
public class PowerUp : MonoBehaviour {
	...
	void Awake(){
		...
		// the surface of the sphere wth a radius of 1m around the origin
		...
		// Above sets the velocity length to somethig between the x and y
	...
	void Update () {
		...
		//Given the default values, a PowerUp will exist for 10seconds
		// and then fades out over 4 seconds
		...
		if (u>0) {
			...
			// Fade the Letter too, just ot as much
			c = letter.color;
			c.a = 1f - (u * 0.5f);
			letter.color = c;
	}
	...
	void CheckOffscreen(){
		// If the PowerUp has drfited entirely off screen...
